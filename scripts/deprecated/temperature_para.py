...
if temperature:
  temp = [T for T in N.arange(0,N.float(temp_info[0]),N.float(temp_info[1]))]
  if lifetime:
    ...
    ncfile.createDimension('number_of_temperature',N.float(temp_info[0])/N.float(temp_info[1]))
    # Create variable
